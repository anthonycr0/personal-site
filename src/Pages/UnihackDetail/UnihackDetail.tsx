            ...
            <div className="info">
              <div className="description">
                ...
                <p>
                  ...
                  <a href="https://unihack.net" className="underline">
                    unihack.net
                  </a>{" "}
                  was reborn.
                </p>
              ...
              <img
                ...
                src={designMarginImg}
                alt="Text aligned to the left margin, with the section's background featuring a full-width background"
              />
              <div className="description">
                <p>
              ...
              <img
                className="promo-image"
                src={designHistoryImg}
                alt="From left to right, a sketch of the site, the wireframe, and two prototypes"
              />
              <div className="description">
                <hr />
                ...
                <p>Angular or React? Or Vue? Or something else entirely?</p>
                ...
                <p>Back in the real world it was a fairly simple choice.</p>
              ...
              <img
                className="promo-image"
                src={codeConfigImg}
                alt="A screenshot of the Next.js and Vercel config files"
              />
              <div className="description">
                <p>
              ...
              <img
                className="promo-image"
                src={websiteScheduleImg}
                alt="A screenshot of the schedule updating live on the website"
              />
              <div className="description">
                <p>
              ...
              <div className="description">
                <hr />
                <p>Oh I almost forgot to answer a question: would we be supporting Internet Explorer?</p>
                <p>
                  <i>Absolutely not.</i>
                </p>
              </div>
